function handles = LayOutEditWindow(handles)
	...
	for TemporaryVariable=1:handles.NumberOfAxes
		...
		set(handles.(['AxisObj' TemporaryVariableString]),'Position',...
			[CurPos(1)+CurPos(3)-CurEditWidth, CurPos(2)+CurPos(4), CurEditWidth, CurEditHeight]);
		set(handles.(['AxisLinkText' TemporaryVariableString]),'Position',...
			[CurPos(1)+CurPos(3), CurPos(2)+CurPos(4), CurLinkTextWidth, CurLinkTextHeight]);
	end
end